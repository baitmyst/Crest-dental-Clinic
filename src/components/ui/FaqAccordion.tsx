        ...
        return (
          <div
            ...
            className={`bg-white rounded-xl border transition-all duration-200 shadow-sm ${
              isOpen
                ? "border-[#0284c7]/40 ring-1 ring-[#0284c7]/10 shadow-md"
          ...
          >
            <button
              ...
              className="w-full flex items-center justify-between gap-4 p-5 text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0284c7] rounded-xl transition-colors"
            >
