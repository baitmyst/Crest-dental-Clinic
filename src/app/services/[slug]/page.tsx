          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-8 space-y-6">
              <span className="text-[13px] font-semibold tracking-wider text-[#0284c7] uppercase">
                {service.category || "Professional"} Dentistry · Kampala
              </span>
                ...
                <div className="p-6 sm:p-7 space-y-5 bg-white">
                  ...
                  <div className="space-y-3 text-[14px]">
                    ...
                    <div className="flex items-center justify-between pb-2.5 border-b border-[#dddddd]">
                      ...
                      <span className="font-medium text-[#181d26]">{service.durationMinutes || 45} minutes</span>
                    </div>
                    <div className="flex items-center justify-between pb-2.5 border-b border-[#dddddd]">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium text-[#0284c7]">Online Guest Request</span>
                    </div>
                  </div>
      ...
      <section className="section-rhythm bg-[#f8fafc] border-b border-[#dddddd]">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {/* Benefits */}
            <div className="bg-white p-8 rounded-xl border border-[#dddddd] space-y-5 shadow-sm">
              ...
              <ul className="space-y-3 text-[14px] text-[#333840]">
                {(benefits.length > 0
                  ? benefits
                  : [
                      "Individualized clinical evaluation with Dr. Silver",
                      "Modern, gentle diagnostic examination techniques",
                      "Transparent treatment options explained clearly",
                      "Supportive follow-up and preventive guidance",
                    ]
      ...
      <section className="section-rhythm bg-white border-b border-[#dddddd]">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link
              href="/services"
              className="text-[14px] font-medium text-[#0284c7] hover:text-[#0369a1] flex items-center gap-1"
            >
              <span>View All</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {relatedServices.map((rel) => (
              <div
                key={rel.slug}
                className="bg-[#f8fafc] border border-[#dddddd] p-6 rounded-lg space-y-3 flex flex-col justify-between card-interactive"
              >
                ...
                <div className="pt-4">
                  <Link
                    ...
                    className="text-[13px] font-medium text-[#0284c7] hover:text-[#0369a1] flex items-center gap-1"
                  >
